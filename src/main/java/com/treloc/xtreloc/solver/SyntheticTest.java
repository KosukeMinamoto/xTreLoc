...
public class SyntheticTest extends SolverBase {
    ...
    public SyntheticTest(AppConfig appConfig, int randomSeed, double phsErr, double locErr, 
        ...
        if (appConfig.getModes() != null && appConfig.getModes().containsKey("SYN")) {
            AppConfig.ModeConfig synConfig = appConfig.getModes().get("SYN");
    ...
    public void generateDataFromCatalog() throws VelocityModelLoadException, IOException {
        ...
        SolverLogger.info("SYN: Starting. Events=" + total);
        ...
        SolverLogger.info("SYN: Completed. Events=" + total);
    }
    ...
    private void printProgressBar(int current, int total, String eventTime) {
        ...
        SolverLogger.fine("SYN: " + progressMsg);
    }
    ...
    public void generateData(Point pointTrue, double minSelectRate, double maxSelectRate) throws VelocityModelLoadException {
        ...
        try {
            ...
            SolverLogger.severe("SYN: " + errorMsg.toString());
