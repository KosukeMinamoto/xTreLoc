...
public class HypoMCMC extends SolverBase {
    ...
    private void initMcmcParams(AppConfig appConfig) {
        JsonNode mcmcSolver = appConfig.getParams() != null ? appConfig.getParams().get("MCMC") : null;
        if (mcmcSolver != null) {
    ...
    public void start(String datFile, String outFile) throws TauModelException {
        ...
        try {
            ...
            SolverLogger.severe("MCMC: " + errorMsg.toString());
        ...
        double res = HypoUtils.standardDeviation(travelTimeResidual);
