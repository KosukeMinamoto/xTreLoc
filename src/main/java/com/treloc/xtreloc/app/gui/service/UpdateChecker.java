...
public class UpdateChecker {
        ...
        try {
            ...
            if (responseCode == HttpURLConnection.HTTP_OK) {
                try (BufferedReader reader = new BufferedReader(
                    ...
                    JsonNode jsonNode = JsonMapperHolder.getMapper().readTree(response.toString());
    ...
    public static boolean downloadUpdate(String downloadUrl, File destinationFile, 
        ...
        try {
            ...
            logger.log(java.util.logging.Level.SEVERE, "Error occurred during download: " + e.getMessage(), e);
        }
        return false;
    }
