...
public class TerminalLauncher {
    ...
    private static boolean launchMacTerminal(String mode, String... args) {
        try {
            ...
            LOG.log(Level.WARNING, "Failed to launch macOS terminal", e);
            return false;
        }
    }
    ...
    private static boolean launchWindowsTerminal(String mode, String... args) {
        try {
            ...
            LOG.log(Level.WARNING, "Failed to launch Windows terminal", e);
            return false;
        }
    }
    ...
    private static boolean launchLinuxTerminal(String mode, String... args) {
        try {
            ...
            LOG.log(Level.WARNING, "Failed to launch Linux terminal", e);
            return false;
        }
    }
