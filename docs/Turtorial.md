...
- **SYN**: Creates synthetic data that can be directly used in location modes (GRD, MCMC, LMO & TRD).
...
- **mode**: Event type (SYN, GRD, LMO, MCMC, TRD, ERR, REF)
...
- `<MODE>`: One of GRD, LMO, MCMC, TRD, CLS, or SYN
